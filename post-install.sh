...
case ${cfn_node_type} in
    ...
    echo 'echo ${cfn_postinstall_args}' >> /home/centos/tonto 
    echo 'echo ${monitoring_url}' >> /home/centos/tonto 
    echo 'echo ${monitoring_dir_name}' >> /home/centos/tonto 
    echo 'echo ${monitoring_tarball}' >> /home/centos/tonto 
    echo 'echo ${setup_command}' >> /home/centos/tonto 
    echo 'echo ${monitoring_home}' >> /home/centos/tonto 
#    MasterServer)
